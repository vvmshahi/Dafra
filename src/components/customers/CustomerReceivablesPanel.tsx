...
function ledgerTypeLabel(type: string) {
  return ({ invoice: 'Invoice', payment_receipt: 'Payment', credit_note: 'Credit note', debit_note: 'Debit note', payment_reversal: 'Payment reversal', adjustment: 'Adjustment' } as Record<string, string>)[type] ?? 'Transaction'
}
