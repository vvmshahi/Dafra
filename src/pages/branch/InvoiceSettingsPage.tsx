...
export default function InvoiceSettingsPage() {
  ...
  const actionOptions = [{ value: 'ask' as const, label: 'Ask every time', description: 'Let the operator choose' }, { value: 'receipt' as const, label: 'Print receipt', description: 'Use the thermal receipt path' }, { value: 'a4' as const, label: 'Print A4 invoice', description: 'Use the A4 invoice path' }, { value: 'none' as const, label: 'No automatic printing', description: 'Finish the sale without printing' }]
