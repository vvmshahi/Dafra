...
import { A4_ARTWORK_BOUNDS, invoiceArtworkObjectPath, isA4ArtworkGeometryWithinBounds, resolveInvoicePresentationSettings, serializeInvoicePresentationSettingsForSave, type UpdateBranchInvoiceSettingsPayload } from '@/lib/invoices/presentationSettings'
...
export default function InvoiceSettingsPage({
  ...
  function validate(value: InvoicePresentationDraft) {
    ...
    if (!isA4ArtworkGeometryWithinBounds(p.a4)) errors.push('artwork')
    return errors
  }
  ...
  const themeKeys: Record<A4TemplateId, { label: string; help: string }> = {
    ...
    creative_studio: { label: 'creativeStudio', help: 'creativeStudioHelp' },
  }
  const themeOptions = A4_NEW_SELECTION_TEMPLATE_IDS.map(value => value === 'executive_professional'
    ...
    : value === 'creative_studio'
      ? { value, label: 'Creative Studio', description: 'Expressive branded canvas, top-right verification, and a visual totals closeout' }
