  ...
  return <div className={`mx-auto max-w-[1440px] space-y-5 ${embedded ? 'pb-24' : 'pb-28'}`}>
    ...
    <div className="grid items-start gap-5 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
      <main className={`${mobilePane === 'preview' ? 'hidden xl:block' : ''} rounded-2xl border border-gray-200 bg-white p-4 shadow-sm sm:p-6`} role="tabpanel">
        ...
        {activeTab === 'a4' && <div className="space-y-5"><div><h2 className="text-base font-bold text-gray-950">{t('printing:invoiceSettings.tabs.a4')}</h2><p className="mt-1 text-xs leading-5 text-gray-500">{t('printing:invoiceSettings.a4.help')}</p></div><Choice label={t('printing:invoiceSettings.a4.theme')} value={p.a4.template_id} onChange={value => updateSection('a4', 'template_id', value)} options={[{ value: 'classic', label: t('printing:invoiceSettings.a4.classic'), description: t('printing:invoiceSettings.a4.classicHelp') }, { value: 'modern_split', label: t('printing:invoiceSettings.a4.modern'), description: t('printing:invoiceSettings.a4.modernHelp') }, { value: 'minimal_professional', label: t('printing:invoiceSettings.a4.minimal'), description: t('printing:invoiceSettings.a4.minimalHelp') }]} /></div>}
