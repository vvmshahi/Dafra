    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[48%] relative bg-[#0F2419] flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          <h2 className="text-4xl font-black text-white leading-tight">{t('auth:invitation.heroTitle')}</h2>
          <p className="text-lg font-light text-white/70">{t('auth:invitation.heroSubtitle')}</p>
        </div>

        <div className="relative z-10">
          <p className="text-white/30 text-xs">{t('auth:invitation.heroNote')}</p>
        </div>
      </div>
      ...
      <div className="relative flex-1 flex items-center justify-center bg-white p-8">
        ...
        <div className="w-full max-w-[420px] space-y-6">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-900">{t('auth:invitation.title')}</h1>
