      ...
      <header className="relative overflow-hidden border-b border-white/10 bg-[#0F2419]">
        ...
        <div className="relative z-10 mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            <Link to="/terms" className="hidden rounded-full px-3 py-2 text-sm font-semibold text-white/78 transition hover:bg-white/[0.06] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D8B76A]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#071510] sm:inline">Terms</Link>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 pb-6 pt-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.22em] text-[#D8B76A]">Privacy</p>
              <h1 className="mt-2 text-3xl font-black leading-tight sm:text-5xl">Privacy Policy</h1>
              <p className="mt-3 max-w-2xl text-base leading-7 text-white/70">
                A practical overview of how Kubri handles business, account, and operational data.
              </p>
            </div>
        ...
        <section className="relative z-10 mx-auto max-w-4xl">
          <div className="rounded-[26px] border border-[#D9CBAA] bg-[#FFFDF7] p-4 shadow-[0_22px_68px_rgba(15,36,25,0.13)] sm:p-6">
            ...
            <div className="mt-4 rounded-2xl border border-[#D9CBAA] bg-gradient-to-br from-[#F8F2E3] to-[#EEF5EA] p-4 text-sm leading-6 text-[#496154]">
              Privacy questions: <a href={EMAIL_LINK} className="font-black text-[#0F3A2A] hover:text-[#A77F29]">{supportConfig.email}</a>
            </div>
          </div>
        </section>
      </main>
