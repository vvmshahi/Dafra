...
assert.ok(owner.includes("Deno.env.get('DAFRA_SERVICE_ROLE_KEY') ?? Deno.env.get('SUPABASE_SERVICE_ROLE_KEY')"))
assert.ok(owner.indexOf("const jwt =") < owner.indexOf('const redirectTo = resolveOwnerSetupRedirectUrl()'))
