...
assert.match(page, /const payload: UpdateBranchInvoiceSettingsPayload = \{/)
assert.match(page, /invoice_language: normalized\.invoiceLanguage === 'ar' \? 'ar' : 'both'/)
assert.match(page, /presentation_settings: presentationSettings/)
assert.doesNotMatch(page, /p_payload:\s*\{[^}]*after_sale_action/)
assert.match(page, /rpc\('update_branch_invoice_settings', \{ p_payload: payload \}\)/)
