...
for (const entry of ['classic_v1', 'modern_split_v1', 'minimal_professional_v1', 'executive_green_v1', 'clean_ledger_v1', 'contemporary_border_v1', 'unknown_historical_template']) assert.match(registry, new RegExp(entry))
...
for (const component of ['ClassicV1', 'ModernSplitV1', 'MinimalProfessionalV1', 'ExecutiveGreenV1', 'CleanLedgerV1', 'ContemporaryBorderV1', 'Seller', 'Buyer', 'ItemTable', 'Totals', 'Payment', 'Footer']) assert.match(renderer, new RegExp(`function ${component}`))
