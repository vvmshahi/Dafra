...
assert.match(pos, /border-\[#0F2419\] bg-\[#0F2419\] text-white shadow-sm/)
...
assert.match(pos, /function SplitPaymentModal\([\s\S]*?bg-\[#fffefb\][\s\S]*?bg-\[#0F2419\]/)
assert.match(pos, /border-\[#d7e5dc\] bg-\[#f4f8f5\]/)
