...
assert.match(page, /border-\[#a7b9a8\] bg-\[#c7d3c7\] text-\[#284534\]/)
assert.match(page, /hover:border-\[#7f9984\] hover:bg-\[#b7cbb9\]/)
assert.match(page, /focus-visible:ring-2 focus-visible:ring-\[#31543f\] focus-visible:ring-offset-2/)
assert.match(page, /data-catalogue-management-actions className="flex flex-wrap items-center gap-1 rounded-xl border border-\[#dedbd0\] bg-\[#f1f0ea\] p-1"/)
assert.match(page, /data-catalogue-management-actions[\s\S]*?hover:bg-\[#fffefa\]/)
