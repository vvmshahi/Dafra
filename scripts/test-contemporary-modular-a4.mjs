...
for (const marker of ['ContemporaryItemName', 'ContemporaryItemTable', 'contemporaryColumnLabel', 'ContemporaryModularDecoration', 'a4-contemporary-document-class', 'a4-contemporary-recipient', 'a4-contemporary-closeout']) assert.match(source, new RegExp(marker))
for (const marker of ['a4-contemporary-decoration__top', 'a4-contemporary-decoration__bottom', 'a4-contemporary-document-class', 'a4-contemporary-recipient', 'a4-contemporary-seller', 'a4-contemporary-items--with-discount', 'a4-contemporary-closeout', 'a4-contemporary-qr', 'a4-contemporary-lower']) assert.match(css, new RegExp(marker))
...
assert.match(css, /\.a4-contemporary-document-class \{[^}]*font-size: 39pt/)
...
try {
  ...
  for (const value of ['a4-contemporary-head', 'a4-contemporary-document-class', 'a4-contemporary-recipient', 'a4-contemporary-seller', 'a4-contemporary-qr', 'a4-contemporary-items', 'a4-contemporary-closeout', 'a4-contemporary-lower', 'INVOICE', 'Trading House', 'Legal Seller Co', '300000000000003']) assert.match(preview, new RegExp(value))
  ...
  assert.match(noLogo, /a4-contemporary-document-class/); assert.doesNotMatch(noLogo, /class="a4-logo|class="a4-qr"/)
