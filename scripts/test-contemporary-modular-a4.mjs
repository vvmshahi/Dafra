...
for (const marker of ['ContemporaryItemName', 'ContemporaryItemTable', 'contemporaryColumnLabel', 'ContemporaryModularDecoration', 'a4-contemporary-head', 'a4-contemporary-closeout']) assert.match(source, new RegExp(marker))
for (const marker of ['a4-contemporary-decoration__top', 'a4-contemporary-decoration__bottom', 'a4-contemporary-head--brandless', 'a4-contemporary-parties', 'a4-contemporary-items--with-discount', 'a4-contemporary-closeout', 'a4-contemporary-qr']) assert.match(css, new RegExp(marker))
...
assert.match(css, /\.a4-contemporary-brand \{ display: grid; align-self: end; min-width: 0; padding-inline-start: 3mm/)
assert.match(css, /\.a4-contemporary-brand \.a4-display-heading \{[^}]*font-size: 15pt/)
assert.match(css, /\.a4-contemporary-qr \{ display: grid; place-items: center; align-self: center; padding: 1mm/)
assert.match(css, /\.a4-contemporary-qr \.a4-qr img,.a4-contemporary-qr \.a4-qr-placeholder \{ width: 22mm; height: 22mm/)
assert.match(css, /\.a4-contemporary-parties \{[^}]*grid-template-columns: 1\.05fr \.95fr/)
assert.match(css, /\.a4-contemporary-party \{[^}]*padding-inline-start: 3mm/)
assert.match(css, /\.a4-contemporary-items th \{ padding: 1\.55mm 1\.05mm/)
assert.match(css, /\.a4-contemporary-closeout \{[^}]*grid-template-columns: 30mm minmax\(0,1fr\) minmax\(64mm,76mm\); gap: 5mm; align-items: center/)
...
try {
  ...
  assert.match(noLogo, /a4-contemporary-head--brandless/); assert.doesNotMatch(noLogo, /class="a4-logo|class="a4-qr"/)
