...
assert.match(receiptView, /showReceiptAction && showInvoiceAction/, 'POS success modal should handle both print actions')
assert.match(receiptView, /showReceiptAction \?/, 'POS success modal should handle receipt-only actions')
assert.match(receiptView, /showInvoiceAction \?/, 'POS success modal should handle invoice-only actions')
