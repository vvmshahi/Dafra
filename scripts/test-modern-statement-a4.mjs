...
for (const marker of ['a4-statement-head--identityless', 'a4-statement-qr-card', 'a4-statement-items--with-discount', 'a4-statement-closeout', 'a4-statement-closeout \\+ .a4-footer:empty']) assert.match(css, new RegExp(marker))
