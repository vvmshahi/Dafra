...
assert.match(contract, /COALESCE\(v_product\.track_stock, false\) IS TRUE[\s\S]*?COALESCE\(v_product\.is_service, false\) IS FALSE[\s\S]*?v_product\.receiving_enabled IS NOT TRUE/)
