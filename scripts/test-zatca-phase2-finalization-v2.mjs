...
const files = [
  ...
  '11_durable_simplified_reporting_outbox.sql', 'CONTRACT.md',
]
...
await test('27 frontend production reads safe status instead of raw v2 invoice columns', () => {
  ...
  assert.match(invoiceDetail, /getInvoiceZatcaOutputState/)
  assert.match(invoiceDetail, /getSandboxValidationStatus/)
  assert.match(receiptPrint, /getInvoiceZatcaOutputState/)
