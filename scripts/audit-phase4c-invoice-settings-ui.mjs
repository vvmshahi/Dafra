...
for (const field of ['display_heading', 'display_subheading', 'custom_display_name', 'show_company_name', 'show_branch_name', 'show_phone', 'show_address', 'thank_you_message', 'footer_note', 'refund_note', 'asset_path', 'asset_version', 'width', 'density', 'qr_size', 'wrap_item_names', 'show_cash_change', 'template_id']) assert.match(page, new RegExp(field), `missing UI mapping for ${field}`)
