...
assert.doesNotMatch(receiptAutoPrint, /qrStatus|qrDataUrl|QR_(?:RENDER|DISPLAY)_TIMEOUT/)
assert.doesNotMatch(electronReceiptReady, /qrStatus|qrDataUrl|QR_(?:RENDER|DISPLAY)_TIMEOUT/)
