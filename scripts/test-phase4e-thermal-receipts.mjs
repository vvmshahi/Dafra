...
assert.match(invoiceDetail, /async function handlePrintThermal\(\)[\s\S]*?printCurrentPageDocument\('kubri-print-root', 'receipt'\)/); assert.match(invoiceDetail, /qrUnavailable/)
