...
assert.match(modal, /bg-\[#173f2a\] p-4 text-\[#fff8e7\]/)
assert.match(modal, /text-\[#fff8e7\]\/75/)
assert.match(modal, /border-white\/15 pt-3 text-base font-bold/)
assert.match(history, /bg-\[#173f2a\] text-\[#fff8e7\] shadow-/)
