-- ============================================================
-- Phase 4H: Owner Setup Completion Tracking
-- Apply manually after Phase 4B/4C/4D/4G are in place.
-- ============================================================
--
-- Goals:
--   - Mark owner setup complete when an authenticated owner sets a password
--     or successfully logs in.
--   - Keep the operation scoped to the caller's own tenant.
--   - Preserve completed timestamps and later onboarding statuses.
--
-- Important:
--   - Do not run automatically from CI.
--   - Do not apply automatically to production.
--   - Do not modify POS checkout, register sessions, branch limits,
--     manual suspension, VAT/tax/payment/invoice/ZATCA/reports/printer,
--     Electron, Edge Functions, or branch username login.
