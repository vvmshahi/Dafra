-- Remove the inherited row_security session override from the V2 RPCs and
-- enforce the fixed Trading scope inside the session-creation RPC itself.
BEGIN;
...
ALTER FUNCTION public.activate_zatca_sandbox_v2_session(UUID) RESET row_security;
